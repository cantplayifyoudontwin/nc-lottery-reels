...
class ReelGenerator:
    ...
    def create_title_slide(self, date_str: str) -> Image.Image:
        ...
        draw.rounded_rectangle(
            [(120, disclaimer_y - 30), (self.width - 120, disclaimer_y + 100)],
            radius=20,
            fill=(0, 0, 0, 180)
        )
    ...
    def create_game_slide(self, game: GameData, differential: float, 
        ...
        draw.rounded_rectangle(
            [(100, info_y - 20), (self.width - 100, info_y + 80)],
            radius=15,
            fill=(0, 0, 0, 200)
        )
        ...
        if is_blurred:
            draw.rounded_rectangle(
                [(80, info_y + 110), (self.width - 80, info_y + 250)],
                radius=15,
                fill=(255, 215, 0, 230)
            )
    ...
    def create_cta_slide(self) -> Image.Image:
        ...
        draw.rounded_rectangle(
            [(100, box_top), (self.width - 100, box_top + 220)],
            radius=20,
